  ...
  Drupal.behaviors.calendarViewMultiday = {
    attach(context, settings) {
      ...
      once('calendar-view-multiday', firstInstances, context).forEach(function (firstInstance) {
        ...
        // Get reference "sizes".
        const firstInstanceBound = firstInstance.getBoundingClientRect();
        firstInstance.style.height = firstInstanceBound.height;
        ...
        rowInstances.forEach(function (instance) {
          ...
          if (instance != firstInstance) {
            ...
            if (instanceBound.top < firstInstanceBound.top) {
              instance.style.marginTop = (firstInstanceBound.top - instanceBound.top) + 'px';
            }
          }
        });
      });
